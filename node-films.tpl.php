...
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?>"><div class="node-inner">
  ...
  <?php endif; ?>
  <div class="filminfo">
	<?php print $node->content['field_film_photo']['#children']; ?>
	<?php print $node->content['field_film_year']['#children']; ?>
	<?php print $node->content['field_film_duration']['#children']; ?>
	<?php print $node->content['field_film_distributors']['#children']; ?>
	<?php print $node->content['field_film_buy']['#children']; ?>
