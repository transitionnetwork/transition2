...
// add the related initiatives for this project
$projects_list = views_embed_view('initiative_directory', 'block_3', $nid);
if (strlen($projects_list) < 150) $projects_list = false;
if ($projects_list) {
  $projects_list = '<div class="related-initiatives"><strong>Related Initiatives</strong>' . $projects_list . '</div>';
}

$location_block .= $projects_list . '</div>';
...
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?>"><div class="node-inner">
  ...
  <?php endif; ?>
   ...
   <div class="content">
    <?php if (!$teaser) print $location_block; ?>
    <?php print $content; ?>
    <?php print $projects_list; ?>
  </div>
