 ...
 */
// Get the event point of contact's user account, see if we can contact them and build a nice button if so
if ($field_primarycontact[0]['uid']) {
  $primary_poc = user_load($field_primarycontact[0]['uid']);
  $contact_link = false;
  if ($primary_poc->contact) {
    $contact_link = l(
      '<span>' . t('Event Contact') . '<span>',
...
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?>"><div class="node-inner">
  ...
  <div class="content">
    ...
    <div class="field field-type-date field-field-occurs">
      <div class="field-items">
        <div class="field-item odd"><strong><?php print $field_occurs[0]['view']; ?></strong></div>
      </div>
    </div>
    <?php print $content; ?>
